<%-- 
    Document   : sellProducts
    Created on : Dec 23, 2019, 1:15:24 PM
    Author     : suliman
--%>
        ...
        <div class="container-wrapper">
            <div class="container">
                <div class="page-header">
                    ...
                    <form:form action="${pageContext.request.contextPath}/product/user/addProduct?_csrf=${_csrf.token}" method="POST" commandName="product" enctype="multipart/form-data">
                        <div class="form-group">
                            <form:input type="hidden" value="${pageContext.request.userPrincipal.name}" id="productOwner" path="productOwner" class="form-Control"/>

                            <label for="name" > Name:  </label>
                            <form:input id="name" path="productName" class="form-Control"/>
                            <form:errors path="productName" style="color:#ff0000" />
                        </div>
                        ...
                        <a href="<c:url value="/product/user/myProducts"/>" class="btn btn-default">Cancel</a>
