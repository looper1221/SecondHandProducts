        ...
        <div class="container-wrapper">
            <div class="container">
                <div class="page-header">
                    ...
                    <form:form action="${pageContext.request.contextPath}/admin/product/addProduct?_csrf=${_csrf.token}" method="POST" commandName="product" enctype="multipart/form-data">
