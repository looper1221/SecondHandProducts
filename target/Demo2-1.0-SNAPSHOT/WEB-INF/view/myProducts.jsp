...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            ...
            <table class="table table-hover table-dark">
                ...
                <tbody>
                    ...
                    <c:forEach items="${products}" var="product">
                        <c:if test="${currentUser eq product.productOwner}">
                            <tr>
                                ...
                                <td><a href="<c:url value="/product/user/deleteProduct/${product.productId}"/>" >
                                        <span class="glyphicon glyphicon-remove"></span></a></td>

                                <td><a href="<c:url value="/product/user/editMyProduct/${product.productId}"/>" >
            ...
            <a href="<c:url value="/product/user/addProduct"/>" class="btn btn-success">Add Product</a>
            <br/><br/>
